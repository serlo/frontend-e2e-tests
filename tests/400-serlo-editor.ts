...
Scenario.only('Multimedia plugin controls', async ({ I }) => {
  ...
  // Add a new Multimedia plugin and ensure that it is present
  I.click('$add-new-plugin-row-button')
  I.type('Multimedia')
  I.pressKey('Enter')
  ...
  // Change the size of the multimedia content
  ...
  // Change the type of the multimedia content to GeoGebra
  I.click('$plugin-multimedia-settings-button')
